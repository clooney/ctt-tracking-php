# Portugal Post - CTT Tracking API For PHP
Portugal Post - CTT Tracking API and webhook make it easy to integrate Portugal Post - CTT Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a Portugal Post - CTT Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Portugal Post - CTT Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Portugal Post - CTT Tracking API](https://www.trackingmore.com/ctt-tracking.html)  to:

   *   Get Portugal Post - CTT realtime tracking info of muti-carriers in one integration
   *   Provide Portugal Post - CTT shipment tracking experience like Amazon
   *   Push Portugal Post - CTT notifications of package update with webhook
   *   Verify Portugal Post - CTT delivery exception before it is too late
